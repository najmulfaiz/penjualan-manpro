                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="me-3">
                                    ...
                                    <h3 class="mb-0 fw-bold">{{ $produk_count }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="me-3">
                                    ...
                                    <h3 class="mb-0 fw-bold">Rp{{ number_format($penjualan_count, 2, ',', '.') }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap">
                                <div class="me-3">
                                    ...
                                    <h3 class="mb-0 fw-bold">Rp{{ number_format($pembelian_count, 2, ',', '.') }}</h3>
                                </div>
